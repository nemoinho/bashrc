...
alias composer="docker run --rm \$WEB_DEV_IT -v \$PWD:/app -v /etc/passwd:/etc/passwd:ro -v /etc/group:/etc/group:ro -v ~/.ssh/:\$HOME/.ssh/:ro -w /app \$PARAM_MAP -u \$(id -u):\$(id -g) composer composer"
